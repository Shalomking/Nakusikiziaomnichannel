        ...
        <div class="modal-body">
            <div class="form-row">
                ...
                <div class="form-group col-md-7">
                    <div class="form-group">
                        <label>
                            {__("lang_forms_whatsapp_numbersgroupsname")} <i class="la la-info-circle" title="{__("lang_forms_whatsapp_numbersgroupshelp")}"></i>
                        </label>
...
"></textarea>
                ...
                <div class="form-group col-md-4">
                    <label>
                        {__("lang_and_whatsbulk_55")} <i class="la la-info-circle" title="{__("lang_and_whatsbulk_55_1")}"></i>
                    </label>
                ...
                <div class="form-group col-md-4">
                    <label>
                        {__("lang_form_groups")} <i class="la la-info-circle" title="{__("lang_and_whatsbulk_31")}"></i>
                    </label>
                ...
                <div class="form-group col-md-4">
                    <label>
                        {__("lang_and_whatsbulk_43")} <i class="la la-info-circle" title="{__("lang_and_whatsbulk_43_1")}"></i>
                    </label>
                    <select name="shortener" class="form-control">
                        <option value="0" selected>{__("lang_and_whatsbulk_46")}</option>
                ...
                <div class="form-group col-md-4">
                    <label>
                        {__("lang_form_template")} <i class="la la-info-circle" title="{__("lang_and_whatsbulk_64")}"></i>
                    </label>
                ...
                <div class="form-group col-md-8">
                    ...
                    <button class="btn btn-primary btn-sm" zender-action="translate">
                        <i class="la la-language" title="{__("lang_and_whatsbulk_79")}"></i>
                    </button>
                    ...
                    <label>
                        {__("lang_and_whatsbulk_84")} <i class="la la-info-circle" title="{__("lang_and_whatsbulk_84_1")}"></i>
                    </label>
                    <p>
                    ...
                    <label>
                        {__("lang_form_shortcodes")} <i class="la la-info-circle" title="{__("lang_and_whatsbulk_96")}"></i>
                    </label>
                    {literal}
                    <p>
